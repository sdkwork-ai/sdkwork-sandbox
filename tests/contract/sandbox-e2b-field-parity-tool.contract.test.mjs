...
const REAL_RUST_WORKSPACE = { command: "cargo test --workspace", passed: 94, failed: 0, ignored: 1 };
...
test("the gate's report names the coverage it verified", () => {
  ...
  assert.match(report, /673 contract test\(s\) recomputed from tests\/contract, 94 Rust test\(s\) recorded/);
