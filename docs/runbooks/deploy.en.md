# Runbook — sdkwork-sandbox deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-sandbox-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-sandbox/bundle`, loads the image, starts
